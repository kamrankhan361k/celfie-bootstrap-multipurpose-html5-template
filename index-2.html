...
<div class="site-wrapper">
  <div class="temp-header">
    <div class="header-section style1 pin-style">
      <div class="container">
        <div class="mod-menu">
          <div class="row">
            <div class="col-sm-2"> <a href="index.html" title="" class="logo sty-one"> <img src="images/logo.png" alt=""> </a> </div>
            <div class="col-sm-10">
              <div class="main-nav">
                <ul class="nav navbar-nav top-nav">
                  ...
                  <li class="cart-parent"> <a href="javascript:void(0)" title=""> <i aria-hidden="true" class="icon-basket"></i> <span class="number"> 2 </span> </a>
                    <div class="cart-box">
                      <div class="content">
                        <div class="row">
                          <div class="col-xs-8 f-15"> 2 item(s) </div>
                          <div class="col-xs-4 text-right"> <span>$99</span> </div>
                        </div>
                        <ul class="trbg">
                          <li class="f-15"> <img src="images/cart-img-01.jpg" alt=""> Fashion Hat <span>$30</span> <a href="#" title="" class="close-btn">x</a></li>
                          <li class="f-15"> <img src="images/cart-img-02.jpg" alt=""> Fashion Hat <span>$30</span> <a href="#" title="" class="close-btn">x</a></li>
                        </ul>
                        <div class="row">
                ...
                <div id="menu" class="collapse">
                  <ul class="nav navbar-nav">
                    <li class="active"> <a href="index.html">Home</a> <span class="arrow"></span>
                      <ul class="dm-align-2">
                        <li><a href="index.html">Home Loyout 1</a></li>
                        <li class="active"><a href="index-2.html">Home Loyout 2</a></li>
                    ...
                    <li class="right"> <a href="#" class="m-link">Contact</a> <span class="arrow"></span>
                      <ul class="dm-align-2">
  ...
  <!-- Master Slider -->
  <div class="slide-padtop1">
    <div class="master-slider ms-skin-default" id="masterslider"> 
      
      <!-- slide 1 -->
      <div class="ms-slide slide-1" data-delay="14"> 
        <!-- slide background --> 
        <img src="masterslider/blank.gif" data-src="images/masterslider/slide-bg-18.jpg" alt="Slide1 background"/>
        <h3 class="ms-layer title2 white text-center"
			style="left:0px; top: 320px;"
			data-type="text"
            data-effect="top(45)"
            data-duration="1000"
            data-delay="800"
            data-ease="easeOutExpo">Grow Your Business</h3>
        <h3 class="ms-layer text1 white text-center wide-100"
			style="left:0px; top:410px;"
			data-type="text"
            data-effect="bottom(45)"
            data-duration="1000"
            data-delay="1400"
            data-ease="easeOutExpo">Nam nec tellus a odio tincidunt auctor a ornare odio sed non vitae erat consequat auctor euin elit.<br>
          Auctor a ornare odio sed non vitae erat consequat auctor eu in elit.</h3>
        <div class="ms-layer btn5 sty4"
			style="left: 620px; top: 540px;"
            data-delay="1600"
            data-duration="1000"
            data-effect="left(50)"
      ...
      <div class="ms-slide slide-2" data-delay="10"> 
        ...
        <!-- slide background --> 
        <img src="masterslider/blank.gif" data-src="images/masterslider/slide-bg-19.jpg" alt="Slide background"/>
        <h3 class="ms-layer title2 white text-center"
			style="left:0px; top: 320px;"
			data-type="text"
            data-effect="top(45)"
            data-duration="1000"
            data-delay="800"
            data-ease="easeOutExpo">Perfect for Startups</h3>
        <h3 class="ms-layer text1 white text-center wide-100"
			style="left:0px; top:410px;"
			data-type="text"
            data-effect="bottom(45)"
  ...
  <div class="section-lg">
    <div class="container">
      <div class="col-sm-8 col-sm-offset-2 text-center m-bot-4">
        ...
        <p class="f-15">Dolor sit amet isse potenti nulla esquam ante aliquet lacusemper elit Sed id dolor consectetur fermentum volutpat accumsan purus.</p>
      </div>
    </div>
    <div class="col-md-6 nopadding">
      <div class="img-frame"> <img src="images/img-28.jpg" alt="" class="img-responsive">
        <div class="img-frame-overlay"></div>
      </div>
      <div class="col-md-12 nopadding bg-sea-color">
        <div class="pad-50">
          <h2 class="m-bot-3 white">Bootstrap Based Multi-Purpose HTML5 Template</h2>
          <p class="white">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </p>
        </div>
      </div>
    </div>
    <div class="col-md-6 nopadding bg-light">
      <div class="pad-50">
        <p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled. Lorem ipsum dolor sit amet isse potenti nulla esquam ante aliquet lacusemper elit. Passages more recently with desktop publishing Donec posuere.</p>
        <p class="m-bot-25">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled.</p>
        <div class="row">
          <div class="col-md-6">
            <div class="feature-col animate-in" data-anim-type="fade-in-left" data-anim-delay="100"> <span class="icon-mobile f-45 color-sea"></span>
              <div>
                <h2 class="f-15 uppercase font-bold">Fully Responsive</h2>
                <p>Lorem ipsum dolor sit amet isse potenti nulla esquam ante aliquet lacusemper elit aliquet.</p>
              </div>
            </div>
            <div class="feature-col animate-in" data-anim-type="fade-in-left" data-anim-delay="200"> <span class="icon-trophy f-45 color-sea"></span>
              <div>
                <h2 class="f-15 uppercase font-bold">Premium Support</h2>
                <p>Lorem ipsum dolor sit amet isse potenti nulla esquam ante aliquet lacusemper elit aliquet.</p>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="feature-col animate-in" data-anim-type="fade-in-left" data-anim-delay="300"> <span class="icon-profile-male f-45 color-sea"></span>
              <div>
                <h2 class="f-15 uppercase font-bold">Expert Advisor</h2>
                <p>Lorem ipsum dolor sit amet isse potenti nulla esquam ante aliquet lacusemper elit aliquet.</p>
              </div>
            </div>
            <div class="feature-col animate-in" data-anim-type="fade-in-left" data-anim-delay="400"> <span class="icon-lightbulb f-45 color-sea"></span>
              <div>
                <h2 class="f-15 uppercase font-bold">Timely Updates</h2>
                <p>Lorem ipsum dolor sit amet isse potenti nulla esquam ante aliquet lacusemper elit aliquet.</p>
              </div>
            </div>
          </div>
  ...
  <div class="clearfix"></div>
  <section class="section-lg no-padd m-top-3px bg-black-light">
    <div class="col-md-6 nopadding">
      <div class="video-box">
        <div class="video-inner no-redius">
          <div class="image"><img src="images/img-33.jpg" alt="" class="img-responsive"></div>
          <div class="video-body"><a class="bla-1 video-link" href="https://www.youtube.com/watch?v=nRpH73tkITY"> <span class="icon-play"><i class="fa fa-play space-40"></i></span> </a> </div>
        </div>
      </div>
    </div>
    <!--end title-->
    <div class="col-md-6 nopadding bg-black-light">
      <div class="pad-50 m-bot-5">
        <div id="carousel-example-generic2" class="carousel slide m-top-4" data-ride="carousel"> 
          <!-- Indicators -->
          <ol class="carousel-indicators">
            <li data-target="#carousel-example-generic2" data-slide-to="0" class="active"></li>
            <li class="" data-target="#carousel-example-generic2" data-slide-to="1"></li>
            <li class="" data-target="#carousel-example-generic2" data-slide-to="2"></li>
          </ol>
          ...
          <div class="carousel-inner font-white col-testimonials" role="listbox">
            <div class="item active">
              <div class="box-testimony ">
                <figure class="m-bot-2"><img src="images/img-31.png" alt=""></figure>
                <p class="testi-info white">Lorem ipsum dolor sit amet, consecte tur adipiscing elit. Fusce cursus leoorci, id a pharetra odio varius integer ccumanosue erat ac porttitor. Vestibul umpor ttitor est, sed pharetra dapibus an sed.</p>
                <div class="author v-line">
                  <h5 class="white">John Deo</h5>
                  <span class="subtext">Executive Director</span> </div>
              </div>
            </div>
            <div class="item">
              <div class="box-testimony ">
  ...
  <section class="section-lg bg-light">
    <div class="container">
      ...
      <!-- row end -->
      <div class="row">
        <div class="col-md-4 col-sm-12 col-xs-12 m-bot-3">
          <div class="feature-col-03 text-left"><i class="icon-tools-2 f-50 color-sea"></i>
            <h3 class="uppercase f-15 font-bold">Easy to Customize</h3>
            <p>Praesent sollicitudin mi ac massa con gue commodo. Nunc et pretium tortor a consequat dolor nulla.</p>
            <div class="readmore styone plain"><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i> Readmore</a></div>
          </div>
        </div>
        <div class="col-md-4 col-sm-12 col-xs-12 m-bot-3 animate-in" data-anim-type="fade-in-down" data-anim-delay="100">
          <div class="feature-col-03 text-left"><i class="icon-puzzle f-50 color-sea"></i>
            <h3 class="uppercase f-15 font-bold">Premium Support</h3>
            <p>Lorem ipsum dolor sit amet isse potenti nulla esquam ante aliquet lacusemper elit posuere esquam ante aliquet.</p>
            <div class="readmore styone plain"><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i> Readmore</a></div>
          </div>
        </div>
        <div class="col-md-4 col-sm-12 col-xs-12 m-bot-3">
          <div class="feature-col-03 text-left"><i class="icon-profile-male f-50 color-sea"></i>
            <h3 class="uppercase f-15 font-bold">ONLINE DOCUMENT</h3>
            <p>Praesent sollicitudin mi ac massa congue commodo. Nunc et pretium tortor, nec consequat dolor.</p>
            <div class="readmore styone plain"><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i> Readmore</a></div>
          </div>
        </div>
        <div class="col-md-4 col-sm-12 col-xs-12 m-bot-3 animate-in" data-anim-type="fade-in-down" data-anim-delay="200">
          <div class="feature-col-03 text-left"><i class="icon-profile-female f-50 color-sea"></i>
            <h3 class="uppercase f-15 font-bold">CUSTOMER SATISFACTION</h3>
            <p>Lorem ipsum dolor sit amet isse potenti nulla esquam ante aliquet lacusemper elit posuere esquam ante aliquet.</p>
            <div class="readmore styone plain"><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i> Readmore</a></div>
          </div>
        </div>
        <div class="col-md-4 col-sm-12 col-xs-12 m-bot-3">
          <div class="feature-col-03 text-left"><i class="icon-pricetags f-50 color-sea"></i>
            <h3 class="uppercase f-15 font-bold">Content Marketing</h3>
            <p>Praesent sollicitudin mi ac massa congue commodo. Nunc et pretium tortor, nec consequat dolor.</p>
            <div class="readmore styone plain"><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i> Readmore</a></div>
          </div>
        </div>
        <div class="col-md-4 col-sm-12 col-xs-12 m-bot-3 animate-in" data-anim-type="fade-in-down" data-anim-delay="300">
          <div class="feature-col-03 text-left"><i class="icon-gears f-50 color-sea"></i>
            <h3 class="uppercase f-15 font-bold">Easy to Customize</h3>
            <p>Lorem ipsum dolor sit amet isse potenti nulla esquam ante aliquet lacusemper elit posuere esquam ante aliquet.</p>
            <div class="readmore styone plain"><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i> Readmore</a></div>
          </div>
  ...
  <div class="section-lg bg-sea-light">
    <div class="container">
      <div class="row">
          ...
          <div class="carousel-inner font-white col-testimonials" role="listbox">
            <div class="item">
              <div class="col-md-8 col-sm-offset-2">
                <div class="text-center"> <i class="count-icon icon-quote f-50 white m-bot-2"></i>
                  <p class="white f-20 line-height-30">Lorem ipsum dolor sit amet, consecte tur adipiscing elit. Fusce cursus leoor ci, id a pharetra odio varius integer sed pharetra dapi bussed maecenas aculis consecte cursus adipiscing.</p>
                  <div class="author to-animate">
                    <figure><img src="images/img-20.jpg" class="wid60" alt="Person"></figure>
                    <p class="white m-top-1">John Deo<br>
                      <span class="subtext">Programmer</span> </p>
                  </div>
                </div>
              </div>
            </div>
            <div class="item">
              <div class="col-md-8 col-sm-offset-2">
                <div class="text-center"> <i class="count-icon icon-quote f-50 white m-bot-2"></i>
                  <p class="white f-20 line-height-30">Lorem ipsum dolor sit amet, consecte tur adipiscing elit. Fusce cursus leoor ci, id a pharetra odio varius integer sed pharetra dapi bussed maecenas aculis consecte cursus adipiscing.</p>
                  <div class="author to-animate">
                    <figure><img src="images/img-23.jpg" class="wid60" alt="Person"></figure>
                    <p class="white m-top-1">John Deo<br>
                      <span class="subtext">Programmer</span> </p>
                  </div>
                </div>
            ...
            <div class="item active">
              <div class="col-md-8 col-sm-offset-2">
                <div class="text-center"> <i class="count-icon icon-quote f-50 white m-bot-2"></i>
                  <p class="white f-20 line-height-30">Lorem ipsum dolor sit amet, consecte tur adipiscing elit. Fusce cursus leoor ci, id a pharetra odio varius integer sed pharetra dapi bussed maecenas aculis consecte cursus adipiscing.</p>
                  <div class="author to-animate">
                    <figure><img src="images/img-21.jpg" class="wid60" alt="Person"></figure>
                    <p class="white m-top-1">John Deo<br>
                      <span class="subtext">Programmer</span> </p>
                  </div>
                </div>
  ...
  <div class="section-lg nopadd m-top-10">
    ...
    <div id="js-grid-mosaic-flat" class="cbp cbp-l-grid-mosaic-flat">
      ...
      <div class="cbp-item web-design print"> <a href="images/media/portfolio-5.jpg" class="cbp-caption cbp-lightbox" data-title="Workout Buddy<br>by Tiberiu Neamu">
        <div class="cbp-caption-defaultWrap"> <img src="images/media/thumb/thumb5.jpg" alt=""> </div>
        <div class="cbp-caption-activeWrap">
          <div class="cbp-l-caption-alignCenter">
            <div class="cbp-l-caption-body">
              <div class="cbp-l-caption-title">Workout Buddy</div>
      ...
      <div class="cbp-item web-design motion"> <a href="images/media/portfolio-6.jpg" class="cbp-caption cbp-lightbox" data-title="Workout Buddy<br>by Tiberiu Neamu">
        <div class="cbp-caption-defaultWrap"> <img src="images/media/thumb/thumb6.jpg" alt=""> </div>
        <div class="cbp-caption-activeWrap">
          <div class="cbp-l-caption-alignCenter">
            <div class="cbp-l-caption-body">
              <div class="cbp-l-caption-title">Workout Buddy</div>
      ...
      <div class="cbp-item web-design motion print"> <a href="images/media/portfolio-7.jpg" class="cbp-caption cbp-lightbox" data-title="Workout Buddy<br>by Tiberiu Neamu">
      ...
      <div class="cbp-item web-design motion"> <a href="images/media/portfolio-8.jpg" class="cbp-caption cbp-lightbox" data-title="Workout Buddy<br>by Tiberiu Neamu">
  ...
  <!-- end features Section -->
  <div class="clearfix"></div>
  <div class="section-lg m-top-10 bg-parallax sty-three">
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-xs-offset-1 text-center">
          <h3 class="f-45 m-bot-2 white font-bold">Multi-Purpose HTML5 Template</h3>
          <p class="f-16 line-height-25 white m-bot-4">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged standard dummy text ever since.</p>
          <p class="f-35 color-sea animate-in" data-anim-type="fade-in-up" data-anim-delay="100"><i class="fa fa-phone"></i> 123 456 7890</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="section-lg">
    <div class="container">
      <div class="row team-members">
        ...
        <div class="col-md-4 animate-in m-bot-4" data-anim-type="fade-in-up" data-anim-delay="300">
          <div class="team-sty-one text-center">
            <div class="team-img style-two"><img src="images/img-34.jpg" alt=""/>
              <div class="team-info">
                <h3 class="white">John Deo</h3>
                <p class="white m-bot-1">Software Developer</p>
                <a href="#"><i class="icon-facebook"></i></a> <a href="#"><i class="icon-linkedin"></i></a> <a href="#"><i class="icon-twitter"></i></a> </div>
            </div>
          </div>
        </div>
        <div class="col-md-4 animate-in m-bot-4" data-anim-type="fade-in-up" data-anim-delay="300">
          <div class="team-sty-one text-center">
            <div class="team-img style-two"><img src="images/img-36.jpg" alt=""/>
              <div class="team-info">
                <h3 class="white">John Deo</h3>
                <p class="white m-bot-1">Software Developer</p>
                <a href="#"><i class="icon-facebook"></i></a> <a href="#"><i class="icon-linkedin"></i></a> <a href="#"><i class="icon-twitter"></i></a> </div>
        ...
        <div class="col-md-4 animate-in m-bot-4" data-anim-type="fade-in-up" data-anim-delay="300">
          <div class="team-sty-one text-center">
            <div class="team-img style-two"><img src="images/img-35.jpg" alt=""/>
              <div class="team-info">
                <h3 class="white">John Deo</h3>
                <p class="white m-bot-1">Software Developer</p>
                <a href="#"><i class="icon-facebook"></i></a> <a href="#"><i class="icon-linkedin"></i></a> <a href="#"><i class="icon-twitter"></i></a> </div>
  ...
  <div class="section-lg">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 post-item m-bot-3">
          <div class="post-item-wrap">
            <div class="post-image sty-one"><a href="#"><img alt="" src="images/img-10.jpg" class="img-responsive"></a></div>
        ...
        <div class="col-md-4 post-item m-bot-3">
          <div class="post-item-wrap">
            <div class="post-image sty-one"><a href="#"><img alt="" src="images/img-11.jpg" class="img-responsive"></a></div>
            <div class="post-item-description nopad-side">
              <h2><a href="#">The Multi-purpose HTML5 Theme</a></h2>
              <span class="post-meta-date"><i class="fa fa-calendar-o"></i> Jan 21, 2017</span> <span class="post-meta-comments"><a href=""><i class="fa fa-comments-o"></i> 33 Comments</a></span>
              <p>Dolor sit amet isse potenti nulla esquam ante aliquet lacusemper elit Sed ante aliquet id dolor consectetur fermentum.</p>
        ...
        <div class="col-md-4 post-item m-bot-3">
          <div class="post-item-wrap">
            <div class="post-image sty-one"><a href="#"><img alt="" src="images/img-12.jpg" class="img-responsive"></a></div>
            <div class="post-item-description nopad-side">
              <h2><a href="#">The Multi-purpose HTML5 Theme</a></h2>
              <span class="post-meta-date"><i class="fa fa-calendar-o"></i> Jan 21, 2017</span> <span class="post-meta-comments"><a href=""><i class="fa fa-comments-o"></i> 33 Comments</a></span>
              <p>Dolor sit amet isse potenti nulla esquam ante aliquet lacusemper elit Sed ante aliquet id dolor consectetur fermentum.</p>
  ...
  <div class="clearfix"></div>
  <footer class="footer bg-image m-top-6">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-5 m-bot-2"> 
            ...
            <div>
              <h4 class="f-20 m-bot-2 white">About Us</h4>
              <p>Dolor sit amet isse potenti nulla esquam ante aliquet lacusemper elit Sed id dolor consectetur fermentum volutpat accumsan and purus. Curabitur pulvinar euismod ante.</p>
            </div>
          ...
          <div class="col-md-4 m-bot-2"> 
            ...
            <h4 class="f-20 m-bot-2 white">Quick LInks</h4>
            <div class="row">
              <div class="col-md-6">
                <ul class="list-icon">
          ...
          <div class="col-md-3 m-bot-2"> 
            <!-- Footer widget area 1 -->
            <div>
              <h4 class="f-20 m-bot-2 white">Contact Us</h4>
              <ul class="list-icon">
        ...
        <div class="col-md-12 m-top-2 container">
...
<script type="text/javascript" src="js/masterslider/masterslider.int.js"></script> 
