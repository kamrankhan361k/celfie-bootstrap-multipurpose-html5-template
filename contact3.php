...
<div class="site-wrapper">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="right active"> <a href="#" class="m-link">Contact</a> <span class="arrow"></span>
                      <ul class="dm-align-2">
                        ...
                        <li class="active"><a href="contact3.php"> Contact 3</a></li>
                      </ul>
                    </li>
                  </ul>
                </div>
  ...
  <div class="page-header four">
    <div class="container">
      <div class="col-md-6">
        <h3>Contact Style 3</h3>
        <h4>Get in Touch with Us</h4>
      </div>
      <div class="col-md-6">
        <div class="breadcrumbs"><a href="index.html">Home</a> <i>/</i> <a href="#">Contact</a> <i>/</i> Contact Style 3</div>
      </div>
    </div>
  </div>
  <!-- Sub Header -->
  ...
  <div class="section-lg nopadding">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          ...
          <form action="demo-contacts-process.php" method="post" id="sky-form" class="sky-form sty-one" sty-one novalidate>
